...
bsa$Married2 <- ifelse(bsa$Married.f=="Married/living as married","Partnered",bsa$Married)
bsa$Married2 <- ifelse(bsa$Married.f=="Widowed" | 
                       bsa$Married.f=="Never married" | 
                      bsa$Married.f=="Separated/divorced","Not partnered",bsa$Married2)
...
bsa<-bsa%>%
     mutate(Married3=case_when(
               ...
               Married.f == "Separated/divorced" | Married.f == "Widowed" ~ "Not Partnered",
...
```{r 4.9}
bsa$RAgeCat.f <- as_factor(bsa$RAgeCat) # convert labelled numeric variable into factor
table(bsa$RAgeCat.f)                      

bsa.adults<-bsa[!bsa$RAgeCat.f=="18-24", ] # retains all values except those that match the condiction  
