...
This relies on  a function specified with the `gp=` option which defines the  shading of the colours of the respective cells according to the size of these deviations from expected values, also known as residuals. Thresholds for shading can be customised as required.



```{r 8.8}
#| fig.height: 6
#| fig-alt: "Unweighted mosaic plot of party affiliation by gender showing among other the larger than expected proportion of conservative men"
mosaic(t,                            
       shade=T,
...
```{r 8.10}
#| fig.height: 6
#| fig-alt: "Weighted mosaic plot of party affiliation by gender, this time showing little significant difference between men and women"
mosaic(t,                            
       shade=T,
       gp = shading_hcl,
       labeling=labeling_border(
